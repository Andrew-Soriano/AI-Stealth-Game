...
public class FormationAttackState : BaseState
{
    ...
    public FormationAttackState(EnemyStateMachineController controller, EnemyStateFactory factory,
    ...
    public override void CheckSwitchState()
    {
            ...
            Vector3.Distance(_controller.Trans.position, _controller.Player.position) < _controller.AttackRange)
        {
            ...
            this.SwitchState(_factory.FormationPursuitState(_leader, _formationOffset));
        }
    }
